...
1. keep `NoodlesApple::Core` free of OpenUSD, UIKit, AppKit, and product globals;
...
5. preserve the shared contrived fixture across the iPadOS and macOS demos.

Changes copied from Noodles itself belong upstream in Noodles. NoodlesApple
